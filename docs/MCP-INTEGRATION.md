...
| **DataForSEO** | `dataforseo-mcp-server@3` | Official extension | v3 tools: `api_request`, `docs_search`, `docs_index`, `docs_list_sections` (the 90 per-endpoint tools of v2, last release 2.9.13, were removed in 3.0.0); 23 commands. Needs Node.js 22+. Install: `./extensions/dataforseo/install.sh`. See [extension docs](../extensions/dataforseo/README.md). |
